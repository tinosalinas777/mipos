...
return [
    ...
    "software_short"                 => "La Estacion Repuestos",
    "software_title"                 => "La Estacion Repuestos",
    "state"                          => "Estado",
    "submit"                         => "Enviar",
    "total_spent"                    => "Total gastado",
    "unknown"                        => "Desconocido",
    "view_recent_sales"              => "Ver Ventas Recientes",
    "website"                        => "SoftwareCS.org",
    "welcome"                        => "Bienvenido(a)",
    "welcome_message"                => "Bienvenido a La Estacion Repuestos. Haz click en un módulo, para empezar.",
    "yes"                            => "Si",
